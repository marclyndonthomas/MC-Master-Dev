...
export default function App() {
  ...
  }, [init, contrib, contribEsc, withdraw, escMode, customEsc, skipMode, skipEvery, guardBand, healthThreshold, ret, vol, years, sims, effEsc, lumps, inflation, simMode, otherFees]);
