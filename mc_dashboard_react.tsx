...
export default function App() {
  ...
  }, [init, contrib, contribEsc, withdraw, escMode, customEsc, skipMode, skipEvery, guardBand, healthThreshold, savingsTarget, planMode, effContrib, effWithdrawInput, effRetireMonths, wBasis, wPct, ret, vol, years, sims, effEsc, lumps, inflation, simMode, otherFees]);
